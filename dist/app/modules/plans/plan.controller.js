...
const createPlan = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield plan_service_1.PlanServices.createPlanIntoDB(req.body);
