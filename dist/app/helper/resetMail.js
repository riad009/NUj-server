...
const resetMail = (email, link) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const mailOptions = {
        ...
        text: `Please reset your password from the link below: https://nuj-six.vercel.app/reset-password/${link}`,
    };
    try {
